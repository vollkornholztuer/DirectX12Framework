...
namespace Engine {
	...
	public:
		...
		ID3D12Resource* GetCurrentRenderTarget() { return mRenderTargets[mCurrentBuffer].Get(); }
	...
	private:
		...
		Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> mRTVHeap; // Render Target View Heap
